...
public class FluidProperties {
    ...
    public String toString() {
        return String.format(
            "{boilingTemperature: %d, meltingTemperature: %d, currentTemperature: %d, gas: %s, liquid: %s, tags: %s}",
            boilingTemperature,
            meltingTemperature,
            currentTemperature,
            gas,
    ...
    public static class StateBasedProperties {
        ...
        public String toString() {
            return String.format(
                "{density: %d, viscosity: %d, luminosity: %d, propagatesSkylightDown: %b, isPathfindable: %b}",
                density,
                viscosity,
                luminosity,
