...
public class MM_Material {
    ...
    public String toString() {
        return String.format(
            "{name: %s, tagNames: %s, enabled: %b, enabledTypes: %s, color: %s, burnTime: %d, enchantPowerBonus: %f, fireSpreadSpeed: %d, flammability: %d, jumpFactor: %f, lightLevel: %d, resistance: %f, speedFactor: %f, state: %s, noteblockInstrument: %s, texture: %s, tooltip: %s, block: %s, fluid: %s, item: %s, ore: %s}",
            name,
            tagNames,
            enabled,
            enabledTypes,
